...
class OffsetLists(enum.Enum):
    """
    | made cause I don't want to type
    | for y_off in range(-1, 2):
    |    for x_off in range(-1, 2):
    |        if (x_off == 0 or y_off == 0) and not (x_off == 0 and y_off == 0):
    | anymore
    |
    | format is list[dict[str,int]] w/ the dict looking like {"y_off","x_off"}
    """
    ORTHOGONAL = [{"y_off": 0, "x_off": 1},{"y_off": 0, "x_off": -1},{"y_off": 1, "x_off": 0},{"y_off": -1, "x_off": 0}]
    SURROUNDING = [{"y_off": 1, "x_off": 1},{"y_off": -1, "x_off": -1},{"y_off": 1, "x_off": -1},{"y_off": -1, "x_off": 1},
                   {"y_off": 0, "x_off": 1},{"y_off": 0, "x_off":  -1},{"y_off": 1, "x_off":  0},{"y_off": -1, "x_off": 0}]